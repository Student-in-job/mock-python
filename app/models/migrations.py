...
def init_partners(engine: Engine):
    with Session(engine) as session:
        item_partner = partner_models.Partner(
        ...
        session.commit()
        item_partner_tariff_plan1 = partner_models.PartnerTariffPlan(
            partner_id=1, tariff_plan_id=1, activate_at=datetime.now(), created_at=datetime.now()
        )
        item_partner_tariff_plan2 = partner_models.PartnerTariffPlan(
            partner_id=1, tariff_plan_id=2, activate_at=datetime.now(), created_at=datetime.now()
        )
        item_partner_tariff_plan3 = partner_models.PartnerTariffPlan(
